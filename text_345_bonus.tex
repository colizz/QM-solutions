...
\begin{enumerate}[label=\textbf{3.\Alph*}, listparindent=\parindent]
...
\begin{enumerate}[label=\textbf{4.\Alph*}, listparindent=\parindent]
\setcounter{enumi}{2}
...
\begin{enumerate}[label=\textbf{5.\Alph*}, listparindent=\parindent]
\setcounter{enumi}{1}
...
则四维椭球的超体积为
\[V = \frac{1}{2}\pi^2\cdot\sqrt{2mE_0}\cdot \sqrt{2mE_0} \cdot \sqrt{\frac{2E}{m\omega^2}} \cdot \sqrt{\frac{2E}{m\omega^2}} = \frac{2\pi^2E_0^2}{\omega^2}\]
